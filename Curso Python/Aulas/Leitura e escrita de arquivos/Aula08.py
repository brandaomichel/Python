...
class Carro:
    ...
    def le_carros():
        ...
        dicioinario = json.loads(texto)

        for chave in dicioinario:
            carro = Carro(chave, dicioinario[chave])
            lista.append(carro)
        
        return lista

carro1 = Carro('Fusca', 40)
carro2 = Carro('Nivus', 50)
carro3 = Carro('Corsa', 20)

Carro.salva_carro(carro1, carro2, carro3)
